...
const CustomerOngoingOrders = () => {
  ...
  const submitOrder = async () => {
    try {
      ...
      fetch(`${baseUrl}/order/getAll?toUserId=${true}&orderStatus=${'pending'}`, requestOptions)
        ...
        <View style={styles.bottomContainer}>
          ...
          <ButtonFilled
            ...
            onPress={() => {
              ...
              navigation.navigate("cancelorder", { orderId: selOrder?._id });
            }}
          />
        </View>
      </RBSheet>
