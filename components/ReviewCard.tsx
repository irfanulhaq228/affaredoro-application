        ...
        <View style={styles.container}>
            <View style={styles.reviewHeaderContainer}>
                ...
                <View style={styles.reviewHeaderRight}>
                    <View style={[styles.starContainer,{borderColor:dark ? COLORS.secondaryWhite : COLORS.greyscale900}]}>
                        <Fontisto name="star" size={10} color={dark ? COLORS.secondaryWhite : COLORS.greyscale900} />
                        <Text style={[styles.rating,{color:dark ? COLORS.secondaryWhite : COLORS.greyscale900}]}>{avgRating}</Text>
                    </View>
                    {/* <Image
